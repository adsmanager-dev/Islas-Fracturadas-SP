...
Las dos potencias toman decisiones humanas y conscientes. Helios no las obliga a invadir. La información seleccionada, retrasada o manipulada que reciben hace que ambos altos mandos concluyan que esperar significaría entregar Altis y Helios al enemigo.

Cada fuerza cree que la otra inició el movimiento irreversible.

> Azul llega para impedir una ocupación.
>
> Rojo llega afirmando que la ocupación ya ha comenzado.
>
...
Su contradicción central es prometer la devolución de la soberanía mientras construye la infraestructura necesaria para permanecer.
...
* el gobierno perdió el control de la crisis;
* Verde cometió abusos contra la población;
* Rojo utiliza un acuerdo secreto para ocupar el archipiélago;
* FIA y otros grupos armados amenazan a los civiles;
* Helios puede convertirse en una herramienta de dominación regional;
* deben establecerse corredores humanitarios y zonas protegidas.
...
* contactos previos entre inteligencia Azul y sectores de FIA;
* vigilancia anterior a la invasión;
* participación de empresas occidentales en Helios;
* planes para asegurar puertos y aeródromos durante un periodo prolongado;
* estudios sobre un gobierno provisional favorable;
* protocolos para copiar información de Helios.
...
* establecer una cabeza de playa occidental;
* mantener abierta la ruta naval;
* asegurar Kavala y la infraestructura occidental;
* capturar radares y comunicaciones;
* obtener acceso a Helios;
* separar a Rojo de los mandos Verdes leales;
* controlar al menos un aeródromo;
* detener la expansión Roja hacia el centro;
* preparar una operación sobre Stratis.

Azul puede aceptar un gobierno independiente si limita su relación con Rojo, permite supervisar Helios, garantiza acceso portuario y aéreo, acepta asistencia militar Azul y excluye a determinados dirigentes.

Una parte de la Coalición también pretende obtener una copia de los archivos y modelos de Helios, información sobre Argos, un acceso permanente y los datos producidos durante la guerra.
...
Ward dirige desde el grupo naval. Es disciplinada, prudente y consciente de que una victoria rápida puede convertirse en una ocupación interminable.

Prioriza el desembarco, la logística naval, la reducción de bajas civiles, la legitimidad política y la obtención de información fiable. Cree que Helios debe neutralizarse o quedar bajo supervisión internacional.
...
Hale considera que una prudencia excesiva permitirá a Rojo consolidarse. Prioriza romper defensas costeras, avanzar con rapidez, tomar aeródromos y comunicaciones, destruir artillería y defensa aérea y explotar la superioridad tecnológica.
...
Su misión oficial es impedir que Helios sea utilizado contra Azul. Su misión reservada es acceder a nodos, copiar información, identificar protocolos, localizar accesos Argos y evaluar qué partes pueden reutilizarse.

Puede ocultar información incluso a Ward y Hale.

La doctora Miriam Kessler dirige su componente técnico.
...
Puede ser una herramienta genuina de protección o la base administrativa de un protectorado.
...
1. localizar al enemigo;
2. aislarlo;
3. cortar su logística;
...
* vulnerabilidad ante insurgencia;
* dificultad para ocupar grandes extensiones;
* exceso de confianza en inteligencia tecnológica;
* rivalidad entre militares, inteligencia y autoridades civiles.
...
* **FIA:** mantiene contactos previos y puede ofrecer armas, inteligencia, medicinas, entrenamiento y apoyo político.
* **Guerrillas:** intenta convertirlas en resistencia contra Rojo, aunque muchas también rechazan a Azul.
* **Civiles:** necesita proteger servicios, cumplir promesas y demostrar que no permanecerá indefinidamente.
...
Rojo prefiere dominar Altis indirectamente: conservar su bandera, mantener instituciones y fuerzas locales, proteger un gobierno dependiente e integrar la infraestructura en una red regional.

Su contradicción central es defender formalmente la soberanía mientras reduce la capacidad real del aliado para decidir.
...
No describe su llegada como una invasión, sino como asistencia militar solicitada por el gobierno legítimo.
...
* asegurar una cabeza de playa oriental;
* contactar con mandos Verdes leales;
* proteger la infraestructura oriental;
* impedir que Azul capture puertos y aeródromos;
* conectar Helios con sus sistemas;
* avanzar mediante líneas fortificadas;
* expulsar o rodear a Azul;
* preservar un gobierno aliado;
* preparar el acceso a Stratis.

Necesita que el Estado, los puertos y Helios continúen funcionando.
...
Navid es paciente y metódico. Comprende que capturar ciudades no equivale a gobernarlas. Prioriza infraestructura, logística, fuerzas locales, consolidación, puertos, centrales y aeródromos.
...
Vahid busca golpear a Azul antes de que consolide su cabeza de playa. Prioriza presión, ofensivas simultáneas, fuerzas mecanizadas, artillería, ruptura de líneas y captura de cruces y aeródromos.
...
Coordina la alianza, pero también supervisa al gobierno, evalúa lealtades, distribuye recursos, controla comunicaciones y selecciona autoridades confiables.
...
Descubre que sus propios códigos producen respuestas diferentes y que alguien modificó el sistema sin informar al Pacto.

El doctor Kamran Sadeq dirige el componente técnico. La coronel Laleh Arman administra aviación y defensa aérea, y el mayor Samir Khadem es el superior operacional directo de RUBÍ-1.
...
1. identificar el punto de ruptura;
2. concentrar fuego;
3. penetrar la defensa;
4. ocupar cruces e infraestructura;
5. desplegar defensa aérea y antitanque;
...
* defensa aérea;
* fortificación y reservas;
* tolerancia a campañas prolongadas;
...
* cadenas de mando rígidas;
* dificultad ante guerrillas dispersas;
* conflictos con unidades locales;
* información filtrada por autoridades poco fiables;
* tendencia a confundir estabilidad con obediencia;
* vulnerabilidad política por la legitimidad del acuerdo.
...
* **FIA:** la condena públicamente, pero puede negociar treguas, comprar información, ofrecer amnistías o armar una facción contra Azul.
* **Guerrillas:** intenta integrarlas, desarmarlas, aislarlas o destruirlas.
* **Civiles:** promete seguridad, electricidad, alimentos y continuidad institucional.
...
|---|---|---|
| Justificación | protección e intervención | legalidad y estabilización |
| Mayor temor | que Rojo capture Helios | que Azul destruya al gobierno |
| Método | precisión, movilidad e inteligencia | presión, profundidad y consolidación |
| Base política | transición hacia un nuevo gobierno | continuidad del gobierno existente |
| Relación con Verde | enemigo que puede reformarse | aliado que puede rebelarse |
| Relación con FIA | socio potencial | enemigo negociable |
| Uso de Helios | reconocimiento y precisión | coordinación, reservas e infraestructura |
| Riesgo militar | fuerza limitada y dependiente de información | fuerza pesada y dependiente de logística |
| Riesgo político | crear un protectorado | imponer dominación indirecta |
| Experiencia inicial | «Venimos a liberar» | «Venimos porque nos llamaron» |
...
Azul recibió indicios de acceso Rojo total a Stratis, entrega de puertos, presencia anticipada de unidades Rojas, destrucción de FIA y cierre de cualquier intervención posterior.

Rojo recibió indicios de una invasión Azul inmediata, derrocamiento del gobierno, contactos entre fuerzas especiales y FIA, y captura o destrucción de Helios.

Distintos mandos Verdes recibieron órdenes de aceptar o detener a Rojo, advertencias incompletas sobre Azul e instrucciones contradictorias para defender las costas.
...
La diferencia está en cómo ejercen el poder:

> Azul transforma la intervención en dependencia mediante instituciones nuevas.
>
> Rojo transforma la alianza en dependencia mediante instituciones existentes.
...
* dirigir su unidad;
* ejecutar misiones;
* priorizar funciones de sectores;
* establecer relaciones locales;
* aceptar o rechazar oportunidades;
* recuperar información;
* influir sobre el mando.

No puede impedir todas las ofensivas ni controlar todo el ejército. Los comandantes IA continúan atacando, defendiendo, enviando convoyes, perdiendo sectores, negociando y respondiendo a Helios.
...
La conclusión no es que ambos bandos sean iguales, sino que alguien comprendía sus diferencias y las utilizó para mantener el escenario activo.

> Azul y Rojo no fueron piezas idénticas.
>
> Precisamente porque reaccionaban de manera diferente, Helios necesitaba probar a los dos.
